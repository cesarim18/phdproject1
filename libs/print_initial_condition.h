...
#ifndef _PRINT_INITIAL_CONDITIONH_
#define _PRINT_INITIAL_CONDITIONH_

void print_IC(double *R,double *A,double *u,double *w,double *L,double *Ut,
...
double *Vz,double *Vex,double *Vey,double *Vez,int Ns,int Nth,int exa)
{
	...
	FILE *radius = NULL;
	sprintf(eps_name,"Example/Ex%d/IC/IC_R.dat",exa);
...
/*
	FILE *area = NULL;
	sprintf(eps_name,"Example/Ex%d/IC/IC_A.dat",exa);
...
*/
	...
	FILE *velu = NULL;
	sprintf(eps_name,"Example/Ex%d/IC/IC_u.dat",exa);
	...
	FILE *velw = NULL;
	sprintf(eps_name,"Example/Ex%d/IC/IC_w.dat",exa);
	...
	FILE *velUt = NULL;
	sprintf(eps_name,"Example/Ex%d/IC/IC_Ut.dat",exa);
	...
	FILE *momL = NULL;
	sprintf(eps_name,"Example/Ex%d/IC/IC_L.dat",exa);
	...
	FILE *pressure = NULL;
	sprintf(eps_name,"Example/Ex%d/IC/IC_P.dat",exa);
...
/*
	FILE *pressureT = NULL;
	sprintf(eps_name,"Example/Ex%d/IC/IC_PT.dat",exa);
...
/*
	FILE *cons_Qs = NULL;
	sprintf(eps_name,"Example/Ex%d/IC/IC_Qs.dat",exa);
...
/*
	FILE *cons_Qt = NULL;
	sprintf(eps_name,"Example/Ex%d/IC/IC_Qt.dat",exa);
...
/*
	...
	sprintf(eps_name,"Example/Ex%d/IC/IC_VT.dat",exa);
...
*/
	...
	FILE *vessel_x = NULL;
	sprintf(eps_name,"Example/Ex%d/IC/IC_Vx.dat",exa);
	...
	FILE *vessel_y = NULL;
	sprintf(eps_name,"Example/Ex%d/IC/IC_Vy.dat",exa);
	...
	FILE *vessel_z = NULL;
	sprintf(eps_name,"Example/Ex%d/IC/IC_Vz.dat",exa);
	...
	sprintf(eps_name,"Example/Ex%d/IC/IC_Velx.dat",exa);
	...
	sprintf(eps_name,"Example/Ex%d/IC/IC_Vely.dat",exa);
	...
	sprintf(eps_name,"Example/Ex%d/IC/IC_Velz.dat",exa);
