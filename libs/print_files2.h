...
//	print_3D(R,A,u,w,L,P,PT,Qs,Qt,VT,D_s,N_th+1,file);
	...
	FILE *radius = NULL;
	sprintf(eps_name,"Example/Ex%d/Files/1_R.dat",carpet);
...
*/
	...
	FILE *velus = NULL;
	sprintf(eps_name,"Example/Ex%d/Files/1_u.dat",carpet);
	...
	FILE *velw = NULL;
	sprintf(eps_name,"Example/Ex%d/Files/1_w.dat",carpet);
	...
	FILE *velUt = NULL;
	sprintf(eps_name,"Example/Ex%d/Files/1_Ut.dat",carpet);
	...
	FILE *velHt = NULL;
	sprintf(eps_name,"Example/Ex%d/Files/1_L.dat",carpet);
...
*/
	...
	FILE *pressure = NULL;
	sprintf(eps_name,"Example/Ex%d/Files/1_P.dat",carpet);
...
void print_vec_pos(double *Vx,double *Vy,double *Vz,int Ns,int Nth,int carpet)
{
	...
	FILE *vessel_x = NULL;
	sprintf(eps_name,"Example/Ex%d/Files/2_Vx.dat",carpet);
	...
	FILE *vessel_y = NULL;
	sprintf(eps_name,"Example/Ex%d/Files/2_Vy.dat",carpet);
	...
	FILE *vessel_z = NULL;
	sprintf(eps_name,"Example/Ex%d/Files/2_Vz.dat",carpet);
...
void print_vec_vel(double *Vx,double *Vy,double *Vz,int Ns,int Nth,int carpet)
{
	...
	FILE *vessel_x = NULL;
	sprintf(eps_name,"Example/Ex%d/Files/3_Velx.dat",carpet);
	vessel_x = fopen(eps_name,"a");
	if(vessel_x==NULL){
	...
	FILE *vessel_y = NULL;
	sprintf(eps_name,"Example/Ex%d/Files/3_Vely.dat",carpet);
	vessel_y = fopen(eps_name,"a");
	if(vessel_y==NULL){
	...
	FILE *vessel_z = NULL;
	sprintf(eps_name,"Example/Ex%d/Files/3_Velz.dat",carpet);
	vessel_z = fopen(eps_name,"a");
	if(vessel_z==NULL){
